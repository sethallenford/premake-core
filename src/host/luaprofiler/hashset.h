...
extern "C" {
     ...
     */
    int hashset_add(hashset_t set, unsigned long item);
     ...
     * exist
     */
    int hashset_remove(hashset_t set, unsigned long item);

    /* check if existence of the item
     *
     * returns non-zero if the item exists and zero otherwise
     */
    int hashset_is_member(hashset_t set, unsigned long item);
