...
hashset_t hashset_create()
{
    ...
    set->items = calloc(set->capacity, sizeof(unsigned long));
    if (set->items == NULL) {
        hashset_destroy(set);
        return NULL;
    }
...
static int hashset_add_member(hashset_t set, unsigned long value)
{
    size_t ii;
...
int hashset_add(hashset_t set, unsigned long value)
{
...
int hashset_remove(hashset_t set, unsigned long value)
{
...
int hashset_is_member(hashset_t set, unsigned long value)
{
    size_t ii = set->mask & (prime_1 * value);
